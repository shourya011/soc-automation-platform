    ...
    <div className="space-y-6 animate-slide-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400">Complete history of all automation actions and system events</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-6">
          <div className="text-sm text-gray-400 mb-1">Escalated</div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white border-opacity-10">
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Playbook</th>
            ...
            <tbody className="divide-y divide-white divide-opacity-5">
              {filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-white hover:bg-opacity-5 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap text-gray-300 text-sm font-mono">
                    {new Date(log.timestamp).toLocaleString()}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <FileText className="w-4 h-4 text-cyber-blue mr-2" />
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-gray-300">{log.user}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
