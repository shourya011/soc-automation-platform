    ...
    <div className="space-y-6 animate-slide-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400">Configure integrations and system preferences</p>
        </div>
      </div>
      ...
      <div>
        <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
          <LinkIcon className="w-6 h-6 text-cyber-blue mr-3" />
          Security Tool Integrations
        </h2>
        <p className="text-gray-400 mb-6">Connect your security tools for automated orchestration</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {integrations.map((integration) => (
            <div key={integration.id} className="glass-card-hover p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center">
                  {integration.status === 'connected' ? (
                    ...
                    <>
                      <XCircle className="w-5 h-5 text-cyber-red mr-2" />
                      <span className="text-cyber-red font-semibold">Disconnected</span>
                    </>
                  )}
                </div>
              </div>
              ...
              <div className="text-sm text-gray-400 mb-1">Type: <span className="text-white">{integration.type}</span></div>
              ...
              <div className="space-y-3 mb-4">
                <input
                  ...
                  className="w-full px-4 py-2 bg-white bg-opacity-5 border border-white border-opacity-10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-cyber-blue transition-colors text-sm"
                />
                <input
                  type="password"
      ...
      <div>
        <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
          <SettingsIcon className="w-6 h-6 text-cyber-purple mr-3" />
          System Preferences
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="glass-card p-6">
            <h3 className="text-lg font-bold text-white mb-4">Automation Settings</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Auto-Response Enabled</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-300">AI Triage Active</span>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" defaultChecked className="sr-only peer" />
                  <div className="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-cyber-blue/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-cyber-blue"></div>
                </label>
